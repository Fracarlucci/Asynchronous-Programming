...
import pcd.ass02.part2.lib.virtualThread.LinkFinderFuture;
import pcd.ass02.part2.lib.virtualThread.WordFinderFuture;
...
public class ReactiveGUI extends JFrame {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ReactiveGUI gui = new ReactiveGUI();
            gui.setVisible(true);
        });
    }
}
